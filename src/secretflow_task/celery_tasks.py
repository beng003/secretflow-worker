...
class SecretFlowTask(Task):
    ...
    def on_retry(self, exc, task_id, args, kwargs, einfo):
        ...
        # 发送重试状态通知
        try:
            _publish_status(task_request_id, "RETRY", {
                "stage": "task_retrying",
    ...
    def on_success(self, retval, task_id, args, kwargs):
        ...
        logger.info(
            f"SecretFlow任务成功: task_id={task_id}, "
            f"request_id={task_request_id}"
        )
...
def execute_secretflow_celery_task(
    ...
    try:
        ...
        try:
            ...
            error_msg = f"任务执行超时: {execution_time:.2f}秒 > {self.soft_time_limit}秒"
        ...
        final_result = {
            **result,
            'celery_metadata': celery_metadata
        }
