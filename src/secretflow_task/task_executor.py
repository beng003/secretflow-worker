...
def _collect_performance_metrics(
    ...
    metrics = {
        ...
        'algorithm_exec_time': round(algorithm_exec_time, 2) if algorithm_exec_time else None,
        'overhead_time': round(
            total_time - (cluster_init_time or 0) - (device_init_time or 0) - (algorithm_exec_time or 0),
            2
        )
    }
