...
class ParameterValidator:
    ...
    def validate_device_configs(self, spu_config: Dict[str, Any], heu_config: Dict[str, Any]) -> bool:
        """验证设备配置
    ...
    def validate_parties_consistency(self, sf_init_config: Dict[str, Any], 
