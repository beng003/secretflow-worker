...
class Settings:
    ...
    def __init__(self):
        ...
        # Celery Worker配置
        self.celery_worker_concurrency = int(
            os.getenv("CELERY_WORKER_CONCURRENCY", "2")
        )
        self.celery_worker_pool = os.getenv("CELERY_WORKER_POOL", "prefork")
        self.celery_worker_autoscale_max = int(
            os.getenv("CELERY_WORKER_AUTOSCALE_MAX", "4")
        )
        self.celery_worker_autoscale_min = int(
            os.getenv("CELERY_WORKER_AUTOSCALE_MIN", "2")
        )
        ...
        self.worker_max_tasks_per_child = int(
            os.getenv("WORKER_MAX_TASKS_PER_CHILD", "1")
        )
        self.worker_task_soft_time_limit = int(
            os.getenv("WORKER_TASK_SOFT_TIME_LIMIT", "3600")
        )
        ...
        self.worker_max_memory_per_child = int(
            os.getenv("WORKER_MAX_MEMORY_PER_CHILD", "200000")
        )
        ...
        self.task_default_routing_key = os.getenv(
        ...
        self.task_reject_on_worker_lost = (
            os.getenv("TASK_REJECT_ON_WORKER_LOST", "true").lower() == "true"
        )
        self.task_track_started = (
            os.getenv("TASK_TRACK_STARTED", "true").lower() == "true"
        )
        self.worker_disable_rate_limits = (
        ...
        self.worker_log_format = os.getenv(
            "WORKER_LOG_FORMAT",
